...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('holiday') }}">Holiday</a></li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store.holiday') }}" method="POST" id="add_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="Offday"><span>Offday</span></option>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Holiday Name" required />
                                    @error('name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>From</label>
                                    <input type="date" name="from" class="form-control start_date @error('from') is-invalid @enderror"/>
                                    @error('from')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>To</label>
                                    <input type="date" name="to" class="form-control end_date @error('to') is-invalid @enderror"/>
                                    @error('to')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="num_of_days" class="form-control num_of_days @error('num_of_days') is-invalid @enderror" readonly />
                                </div>
                            </div>
                        </div>
    ...
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Edit Holiday Page</h5>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/holiday/edit') }}/" + id;
        ...
        // Delete method
        // -----------------------------
        $('body').on('click', '.delete_holiday', function(e) {
            e.preventDefault();
