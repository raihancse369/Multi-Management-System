...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('expense-type') }}">Expense Type</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Create New Expense Type</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('store.expense-type') }}" method="POST" id="add_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Expense Type Name</label>
                                    <input type="text" name="type_name" class="form-control @error('type_name') is-invalid @enderror" placeholder="Enter Expense Type Name" required>
                                    @error('type_name')
    ...
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Edit Expense Type Page</h5>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/expense-type/edit') }}/" + id;
        ...
        // Delete Category
        // -----------------------------
        $('body').on('click', '.delete_expensetype', function(e) {
            e.preventDefault();
