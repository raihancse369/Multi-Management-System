<form method="POST" action="{{ route('update.expense-type', $data->id) }}" id="edit_form">
    @csrf
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" name="type_name" value="{{ old('type_name', $data->type_name) }}" class="form-control @error('type_name') is-invalid @enderror">
                @error('type_name')
