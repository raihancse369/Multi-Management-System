            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('contact') }}">Contact Message</a></li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Show Contact Message</h5>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/contact/edit') }}/" + id;
