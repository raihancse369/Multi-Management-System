<form method="POST" action="{{ route('update.subcategory', $data->id) }}" id="edit_form">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="subcategory_name" value="{{ old('subcategory_name', $data->subcategory_name) }}" class="form-control @error('subcategory_name') is-invalid @enderror" required>
        ...
        $('#edit_form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    toastr.success(res.message || 'SubCategory Updated Successfully.');
