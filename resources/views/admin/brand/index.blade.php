            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('brand') }}">Brand</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store.brand') }}" method="POST" id="add_form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-danger">Image size must be (165px by 40px)</small><hr>
...
<script>
    $(document).ready(function () {
        ...
        $('#add_form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    toastr.success(res.message || 'Brand Inserted Successfully.');
                    form[0].reset();
        ...
        // Delete Method
        $('body').on('click', '.delete_brand', function(e) {
            e.preventDefault();
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        type: 'DELETE',
                        success: function(res) {
                            toastr.success(res.message || 'Brand Deleted Successfully.');
                            table.ajax.reload(null, false);
                        },
                        error: function() {
