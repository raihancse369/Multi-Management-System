<form method="post" action="{{ route('update.about-page', $data->id) }}" id="edit_form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <small class="text-danger">Image size must be (1469px by 980px)</small><hr>
        <img id="imageEdit" src="#" style="display:none; margin-top: 10px;" width="80" />
    </div>

    <div class="form-group">
        <label>Old Image</label><br>
        <img src="{{ asset('uploads/about-page/'.$data->image) }}" width="80" height="80">
    </div>
