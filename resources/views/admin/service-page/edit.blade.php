<form method="post" action="{{ route('update.service', $data->id) }}" id="edit_form" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="service_name" value="{{ $data->service_name }}" class="form-control @error('service_name') is-invalid @enderror">
                @error('service_name')
    ...
    <div class="form-group">
        ...
        <img src="{{ asset('uploads/service-page/'.$data->image) }}" alt="Old Image" width="80" height="80">
    </div>
