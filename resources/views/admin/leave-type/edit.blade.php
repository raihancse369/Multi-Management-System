<form method="POST" action="{{ route('update.leave-type', $data->id) }}" id="edit_form">
    @csrf
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="type_name" value="{{ old('type_name', $data->type_name) }}" class="form-control @error('type_name') is-invalid @enderror" required>
                @error('type_name')
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label>Days</label>
                <input type="text" name="leave_day" value="{{ old('leave_day', $data->leave_day) }}" class="form-control @error('leave_day') is-invalid @enderror">
                @error('leave_day')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
