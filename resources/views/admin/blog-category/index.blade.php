            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('blog-category') }}">Blog Category</a></li>
                        <li><a href="{{ route('blog') }}">Blog Post List</a></li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Create New Blog Category</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('store.blog-category') }}" method="POST" id="add_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Blog Category Name</label>
                                    <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" placeholder="Enter Blog Category Name" required>
                                    @error('category_name')
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#add_form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    toastr.success(res.message || 'Blog category added successfully');
                    form[0].reset();
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/blog-category/edit') }}/" + id;
        ...
        // Delete method
        // -----------------------------
        $('body').on('click', '.delete_blog-category', function(e) {
            e.preventDefault();
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        type: 'DELETE',
                        success: function(res) {
                            toastr.success(res.message || 'Blog category deleted successfully');
                            table.ajax.reload(null, false);
                        },
                        error: function() {
                            toastr.error('Failed to delete blog category.');
                        }
                    });
                }
            });
