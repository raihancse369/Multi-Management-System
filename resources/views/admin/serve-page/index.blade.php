            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('serve') }}">Industry Serve</a></li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Create New Industry Serve</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('store.serve') }}" method="POST" id="add_form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Industry Serve Name</label>
                                    <input type="text" name="serve_name" class="form-control @error('serve_name') is-invalid @enderror" placeholder="Enter Industry Serve Name" required />
                                    @error('serve_name')
                        ...
                        <div class="form-group">
                            <label>Industry Serve Logo</label>
    ...
    $(document).ready(function () {
        ...
        const table = $('.dataTable').DataTable({
            ...
            columns: [
                ...
                { data: 'serve_name', name: 'serve_name' },
                { data: 'slug', name: 'slug' },
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/serve/edit') }}/" + id;
        ...
        $('body').on('click', '.delete_serve', function(e) {
            e.preventDefault();
