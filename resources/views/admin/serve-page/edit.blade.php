<form method="post" action="{{ route('update.serve', $data->id) }}" id="edit_form" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="serve_name" value="{{ $data->serve_name }}" class="form-control @error('serve_name') is-invalid @enderror">
                @error('serve_name')
    ...
    <div class="form-group">
        ...
        <img src="{{ asset('uploads/serve-page/'.$data->image) }}" alt="Old Image" width="80" height="80">
    </div>
