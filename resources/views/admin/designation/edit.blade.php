<form method="POST" action="{{ route('update.designation', $data->id) }}" id="edit_form">
    @csrf
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" name="designation_name" value="{{ old('designation_name', $data->designation_name) }}" class="form-control @error('designation_name') is-invalid @enderror">
