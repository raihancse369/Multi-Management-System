            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('designation') }}">Designation</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store.designation') }}" method="POST" id="add_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Designation Name</label>
                                    <input type="text" name="designation_name" class="form-control @error('designation_name') is-invalid @enderror" placeholder="Enter Designation Name" required>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/designation/edit') }}/" + id;
        ...
        // Delete designation
        // -----------------------------
        $('body').on('click', '.delete_designation', function(e) {
            e.preventDefault();
