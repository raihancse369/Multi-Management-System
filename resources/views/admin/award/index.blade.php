...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{ route('category') }}">Award</a></li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store.award') }}" method="POST" id="add_form">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="award_name" class="form-control @error('award_name') is-invalid @enderror" placeholder="Enter Award Name" required /> 
                                    @error('award_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="award_prize" class="form-control @error('award_prize') is-invalid @enderror" placeholder="Enter Award Prize"/> 
                                    @error('award_prize')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Details</label>
                                    <textarea id="" class="form-control" rows="5" name="details"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Edit Award Page</h5>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: { url: "{{ route('award') }}" },
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                { data: 'employee', name: 'employee' },
                { data: 'award_name', name: 'award_name' },
                { data: 'award_prize', name: 'award_prize' },
        ...
        $('body').on('click', '.edit', function() {
            ...
            const url = "{{ url('admin/award/edit') }}/" + id;
